        ...
        if (mousePressed == true) {
            ...
            if (iskAllowTab()) {
                ...
                for (int i = 0; i < comp.length; i++) {
                    if (comp[i] instanceof CustomButton) {

                        ((CustomButton) comp[i]).setSelected(false);
                        ((CustomButton) comp[i]).setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, kIndicatorColor));
                    }
                }
